...
public:
  ...
  bool is_unkownpoint_ = false;
  bool is_activepoint_ = false;
};
...
public:
  ...
  std::vector<Eigen::Vector3f, Eigen::aligned_allocator<Eigen::Vector3f>> traj_point;
...
struct Cube {
  ...
  Cube(const Eigen::Vector3d& min, const Eigen::Vector3d& max, int id = -1)
    : min_point(min), max_point(max), id(id) {}
};
...
public:
  ...
  void updateSkeleton(std::vector<Eigen::Vector3f, Eigen::aligned_allocator<Eigen::Vector3f>> &new_path,
  ...
  bool has_overlap(const Eigen::Vector3f &box_max_1, const Eigen::Vector3f &box_min_1, const Eigen::Vector3f &box_max_2, const Eigen::Vector3f &box_min_2);
  void get_intersection(const Eigen::Vector3f &box_max_1, const Eigen::Vector3f &box_min_1, 
  ...
  int get_size(const Eigen::Vector3f &box_max_, const Eigen::Vector3f &box_min_);
